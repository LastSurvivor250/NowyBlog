  ...
  return (
    <>
      <div className="mb-16 sm:mb-24">
        <article className="flex flex-row items-start justify-center sm:justify-end sm:mx-10 relative min-h-[164vh] sm:min-h-[85vh]">
          <ConnectedSite />

          <section className="w-full mt-0 sm:mt-24 px-4 sm:px-10 md:px-24 sxl:px-32 flex flex-col items-center">
