  ...
  return (
    <>
      ...
      <article className="flex flex-row items-start justify-end sm:mx-10 relative h-[164vh] sm:h-[85vh]">
        <ConnectedSite />
        <section className="w-full mt-0 margin-right:11rem margin-left:-174px sm:mt-24 sm:px-10 md:px-24 sxl:px-32 flex flex-col items-center justify-center z-2">
