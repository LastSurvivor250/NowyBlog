...
const Header = () => {
  ...
  return (
    <header className="w-full p-4 px-5 pl-170 pr-168 flex items-center justify-between bg-gradient-to-r from-white via-gray-100 to-white dark:from-dark dark:via-gray-800 dark:to-dark shadow-md">
      {/* Logo Section */}
      <Logo />
