        ...
        <section className="w-full mt-0 sm:mt-24   sm:px-10 md:px-24  sxl:px-32 flex flex-col items-center justify-center z-10">
          ...
          <div className="grid grid-rows-2 gap-6 ">
            <div className="grid grid-cols-2 grid-rows-1 gap-6   sm:mt-16 space-between">
              <article className=" col-span-2  sxl:col-span-1 row-span-2 relative width:121%">
                <BlogLayoutOne blog={sortedBlogs[9]} />
              </article>
              <article className=" col-span-2 sm:col-span-1 row-span-1 relative width:72px left:130">
