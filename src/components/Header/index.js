...
const Header = () => {
  ...
  return (
    <header className="w-full p-4  px-5 sm:px-10 flex items-center justify-between">
      ...
      <nav class="fixed top-6 right-1/2 translate-x-1/2 bg-gradient-to-r from-sky-500 to-indigo-500 py-1 px-16 text-white font-medium capitalize items-center hidden sm:flex z-50 transition-all ease duration-300">
